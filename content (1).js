...
const CONFIG = {
  ...
  tagline: "Providing trauma informed training, mentorship, and child advocacy grounded in lived experiences.",

  // Leave "" to show no bio at all (the line disappears from the page).
  bio: "",
  ...
  /* ─────────── 2. SOCIAL LINKS ───────────
     ...
     To add LinkedIn later: { label: "LinkedIn", url: "https://www.linkedin.com/in/..." },  */
  socials: [
    { label: "Email", url: "mailto:emilyEcox98@gmail.com" },
    // "phone" (instead of "url") makes a pop-up with Call + Copy buttons:
    { label: "Phone", phone: "479-262-3472" },
  ],
  ...
  /* ─────────── 3.5 COMING SOON SWITCHES ───────────
     true  = tab shows a "coming soon!" bar and hides its content
     false = tab works normally
     Flip these to false when you're ready to launch each tab. */
  comingSoon: {
    events: true,
    resources: true,
  },
